...
public class Controller {
  //  BirdRepository birdRepository = BirdRepository.getInstace();
 //   UserInterface userInterface = UserInterface.getInstance();
    ...
    public void handleUserSelection(int option) {
        ...
        switch (option) {
            ...
            case 4:
                ...
                break;
            case 5:
                userInterface.printAllSwimmableBirds(birdRepository.getBirdList());
                break;
            case 6:
                userInterface.printAllFlyableBirds(birdRepository.getBirdList());
                break;
            case 7:
                userInterface.printEatBehaviour(birdRepository.getBirdList());
                break;
            case EXIT_VALUE:
    ...
    private void addBird() {
        ...
        System.out.println("Enter is flyable?");
    ...
    private void updateBird(Bird bird) {
        ...
        switch (option) {
            ...
            case 3:
                ...
                break;
            case 4:
                System.out.println("bird isSwimable?");
                bird.isSwimmable = sc.nextBoolean();
                break;
            case 5:
